...
const MPESA_CONFIG = {
  ...
  callbackUrl: process.env.CALLBACK_URL || process.env.MPESA_CALLBACK_URL || (NODE_ENV === 'production' ? 'https://jkuat-online-queue.onrender.com/api/mpesa/callback' : 'http://localhost:3000/api/mpesa/callback')
}
