...
const MPESA_CONFIG = {
  ...
  callbackUrl: process.env.CALLBACK_URL || process.env.MPESA_CALLBACK_URL || (NODE_ENV === 'production' ? 'https://jkuat-online-queue.onrender.com/mpesa-express-simulate/' : 'http://localhost:3000/api/queue/mpesa-callback')
}
